      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
        ...
        >
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="relative z-10 mt-6">
              <Link href={`/projects/${projects[0].id}`} className="text-white underline text-lg">
                Ver detalles
              </Link>
            </div>
          </div>
        ...
        >
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="relative z-10 mt-6">
              <Link href={`/projects/${projects[1].id}`} className="text-white underline text-lg">
                Ver detalles
              </Link>
            </div>
          </div>
      ...
      >
        ...
        <div className="relative z-10 p-10">
          ...
          <div className="relative z-10 mt-8">
            <Link href={`/projects/${projects[2].id}`} className="text-white underline text-xl">
              Ver detalles
            </Link>
          </div>
        </div>
