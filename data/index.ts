...
export const projects = [
  {
    ...
    description: "AG1 is a powdered beverage designed to provide daily foundational nutrition...",
    status: "Previously",
    image: "/images/ag1.jpg", // Ruta de la imagen
    details: "As CDO of Athletic Greens, I was responsible for the digital transformation, growing AG1 to a $1.2B valuation...",
  },
  {
    id: 2,
    title: "Founder & Lead Investor, Axacraft",
    description: "Axacraft was founded to address the needs of the digital transformation market...",
    status: "Currently",
    image: "/images/axacraft.jpg",
    details: "Axacraft has revolutionized consulting with a unique approach, disrupting the industry standards...",
  },
  {
    id: 3,
    title: "Head of Product and Engineering at Hagerty",
    description: "Hagerty is the global leader in classic car insurance...",
    status: "Previously",
    image: "/images/hagerty.jpg",
    details: "I led the digital strategy at Hagerty, enhancing the customer experience and contributing to their growth...",
  },
];
